...
const Header: React.FC<HeaderProps> = ({ worldState, currentScenario, onScenarioChange }) => {
    const isOnline = worldState.execution_context.connectivity_status === "unstable";
    ...
    return (
        <AppBar
            ...
            sx={{
                ...
                boxShadow: 'none', // Чистий флет-дизайн
            ...
            <Container maxWidth={false}>
                <Toolbar disableGutters sx={{ justifyContent: 'space-between' }}>
                    ...
                    <Box sx={{ display: 'flex', gap: 3, alignItems: 'center' }}>
                        ...
                        {/* Динамічний статус зв'язку */}
                        <Chip
                            icon={!isOnline ?
                                <WifiOffIcon style={{ color: 'inherit' }} /> :
                                <WifiIcon style={{ color: 'inherit' }} />
                            }
                            label={!isOnline ? "OFFLINE" : "ONLINE"}
